package com.tcfuture.akka.actor.example.system;
...
// 取进程信息
            ...
            try {
                Map<?, ?> map1 = SystemTest.cpuinfo();
                Thread.sleep(CPUTIME);
                Map<?, ?> map2 = SystemTest.cpuinfo();
...
// System.out.println("s2:"+digitS2.get(0));
    ...
    public void test() throws Exception {
        ...
        double cpuUsage = SystemTest.getCpuUsage();
//当前系统的内存使用率
        double memUsage = SystemTest.getMemUsage();
//当前系统的硬盘使用率
        double diskUsage = SystemTest.getDiskUsage();
